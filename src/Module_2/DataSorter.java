...
public class DataSorter {
    ...
    private static void runSorting() {
        ...
        // Formatted to exactly match your screenshot spacing
        System.out.println("\n====== PERFORMANCE COMPARISON ======");
        System.out.printf("%-12s %-15s %-15s%n", "Algorithm", "Time(ns)", "Time(ms)");
        System.out.printf("%-12s %-15d %-15.6f%n", "Bubble", bubbleTime, bubbleTime / 1000000.0);
        System.out.printf("%-12s %-15d %-15.6f%n", "Merge", mergeTime, mergeTime / 1000000.0);
        System.out.printf("%-12s %-15d %-15.6f%n", "Quick", quickTime, quickTime / 1000000.0);
    }
